...
double *polynomial_regression(double **input_data, const int length, const int n){
    ...
    /*
        Input:
        input_data	...	Doppelzeiger vom Typ "double" mit den Eingabedaten.
                                In der Form:
                                x-Werte: input_data[0 bis n][0]
                                y-Werte: input_data[0 bis n][1]
                                		
        length		...	Anzahl der Messwerte bzw. Anzahl der Zeilen mit den Eingabedaten.
        n		...	Grad der Regression.
             
        Ausgabe:
        Bei Erfolg:
        	Ein Zeiger vom Typ "double" der Länge "n + 1"
        	In den Positionen 0 bis n findet man die Gewichte b0, b^1 ... b^n.
        	An letzter Position das Bestimmthgeitsmaß (R²).
        Bei Fehler:
        	Ein NULL-Zeiger
    */
