    ...
    def create_image(self):
        ...
        try:
            ...
            if (mask_created.get("success")):
                ...
                #lvls1 = np.arange(0, 100, 5)
                
                # Zeichne die 5'er Intervall-Level:
                #contour1 = plt.contour(self.lon_raster, self.lat_raster, self.value_raster, levels=lvls1, colors='#242424', linewidths=0.1, transform=ccrs.PlateCarree(), algorithm='threaded')
                ...
                #lvls2 = [item for item in np.arange(0, 100, 1) if item % 5 != 0]
